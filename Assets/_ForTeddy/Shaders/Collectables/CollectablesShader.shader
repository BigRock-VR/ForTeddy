...
Shader "CollectablesShader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float clampResult160 = clamp( (0.0 + (sin( mulTime133 ) - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) , 0.1 , 0.9 );
			...
			float clampResult161 = clamp( (0.0 + (sin( mulTime128 ) - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) , 0.1 , 0.9 );
...
/*ASEBEGIN
Version=17101
822;235;1338;566;4333.186;389.5008;2.103446;True;False
...
Node;AmplifyShaderEditor.ClampOpNode;161;-2702.979,486.122;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.1;False;2;FLOAT;0.9;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;160;-1192.445,-371.5262;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.1;False;2;FLOAT;0.9;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=40C680B6466F0AD27C6CA163E882ACD0AE103585