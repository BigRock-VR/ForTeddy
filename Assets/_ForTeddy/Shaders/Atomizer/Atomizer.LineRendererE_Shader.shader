...
Shader "Atomizer/laserLineE"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Alpha = ( ( ( temp_output_153_0 * temp_output_164_0 ) * ( pow( ( i.uv_texcoord.x - 0.0 ) , 0.82 ) * pow( ( temp_output_164_0 + ( ( simplePerlin2D165 - temp_output_164_0 ) * 0.43 ) ) , 0.35 ) ) ) * 3.91 );
		}
...
/*ASEBEGIN
Version=16700
177;615;1025;568;1615.162;-1181.643;1.546344;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;172;-1984.123,1852.032;Float;False;Constant;_Float5;Float 5;13;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;173;-2048.123,1724.032;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;174;-1792.123,1788.032;Float;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;168;-1766.928,2078.442;Float;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;175;-1561.045,1801.568;Float;False;2;0;FLOAT;0;False;1;FLOAT;0.82;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;176;-1241.265,1786.966;Float;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;143;-1468.717,128.7754;Float;False;Property;_Color0;Color 0;4;1;[HDR];Create;True;0;0;False;0;0,0.3482039,1,0;0,1.05098,2.996078,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;154;-1420.262,-59.49107;Float;False;Property;_Color1;Color 1;3;1;[HDR];Create;True;0;0;False;0;0,0,0,0;0,0.3764706,2.996078,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;177;-658.5346,1037.98;Float;True;2;2;0;FLOAT;0;False;1;FLOAT;3.91;False;1;FLOAT;0
...
WireConnection;21;9;177;0
ASEEND*/
//CHKSM=110D3408C46BFD397CBE908898A43760473CBA19